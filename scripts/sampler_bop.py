...
import transform_bop as transform
...
def main():
    ...
    print("Number of sampled views: {}".format(len(views)))
    print("Levels of the sampled points: {}".format(set(pts_level)))
    # for i in views:
    #     print(i["R"])
    #     print(i["t"])
